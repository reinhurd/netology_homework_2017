...
if (isset($number)): ?>
    <p>Ответьте, пожалуйста, на следующие вопросы, а также укажите ваше имя.</p>
...
if (isset($_POST["test_check"])&&$gb>0):?>
    <form action="cert_gen.php" method="POST">
        <fieldset><p>Для получения сертификата укажите, пожалуйства, ваше имя, и нажмите Получить сертификат</p>
        <Br><input type="text" name="user_name" placeholder="Ваше имя" required><Br>
