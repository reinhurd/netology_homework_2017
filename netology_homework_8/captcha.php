<?php
//Взято и модифицировано мной с http://easywebscripts.net/php/php_sec_img.php
...
$font = __DIR__.'/fonts/times.ttf';	//Путь к шрифту
...
$_SESSION["cod"] = implode("", $cod);					//переводим код в строку
